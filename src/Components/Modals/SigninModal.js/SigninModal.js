    ...
    <>
      ...
      >
        ...
        <div className="content-container">
          <div className="signin-heading">
            <p>
              Sign in using the email address that you used to create your
              remote software account online.
            </p>
      ...
      >
        ...
        <div className="content-container">
          <div className="signin-heading">
            <span>
              Please provide your organization's OIDC indetifier - contact your
