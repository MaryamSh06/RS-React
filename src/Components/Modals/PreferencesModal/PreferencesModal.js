      ...
      <Row  style={{height:"60vh"}} >
        <Col sm={3} style={{background:"white"}}>
          <Nav variant="pills" className="flex-column">
            ...
            <Nav.Item>
              <Nav.Link eventKey="troubleshooting">Troubleshooting</Nav.Link>
            </Nav.Item>
            <Nav.Item>
        ...
        <Col sm={9} style={{border:"1px solid #a5a5a5"}}>
          <Tab.Content>
            <Tab.Pane className='custom-tab-content' eventKey="privacy"><PrivacyScreen /></Tab.Pane>
            <Tab.Pane className='custom-tab-content' eventKey="appearance">
          ...
          <p className='printing-paragraph'>There is no default printer</p>
          <p className='privacy-label-text'>Printing will not be available unless you install a printer before you connect to VNC Server </p>
            </Tab.Pane>
            <Tab.Pane className='custom-tab-content' eventKey="proxy"><ProxyScreen /></Tab.Pane>
            <Tab.Pane className='custom-tab-content' eventKey="recording"><RecordingScreen /></Tab.Pane>
            <Tab.Pane className='custom-tab-content' eventKey="troubleshooting"><TroubleShootingScreen /></Tab.Pane>
            <Tab.Pane className='custom-tab-content' eventKey="expert"><ExpertScreen /></Tab.Pane>
        ...
        <Modal.Footer className="preference-modal-bottom-container">
          <Button className="next-button" onClick={() => setOpenPreferences(false)}>
            Apply
          </Button>
          <Button className="cancel-button" onClick={() => setOpenPreferences(false)}>
            Cancel
          </Button>
          <Button className="cancel-button" onClick={() => setOpenPreferences(false)}>
            OK
